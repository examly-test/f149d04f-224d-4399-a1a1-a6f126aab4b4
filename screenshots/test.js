...
(async () => {
  ...
  await page.goto('https://8080-bdeebaffedbdaffacfaaeeeefeebaacecacdbb.ide.exam.ly');
  ...
  await page1.goto('https://8081-bdeebaffedbdaffacfaaeeeefeebaacecacdbb.ide.exam.ly');
