...
(async () => {
  ...
  await page.goto('https://8080-bdeebaffedbdaffacfaaeeeefeebaeeafbcecdcaeae.ide.exam.ly');
  ...
  await page1.goto('https://8081-bdeebaffedbdaffacfaaeeeefeebaeeafbcecdcaeae.ide.exam.ly');
